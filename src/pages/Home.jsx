  ...
  return (
    <div className='bg-slate-200 w-full min-h-screen ' >
        ...
        <div className='w-full flex flex-wrap gap-5 px-5 justify-center pt-8 pb-8 ' >
          ...
          <div className=' text-center text-green-500 font-semibold text-2xl pt-5 ' >No dish Found</div>
          }
...
<button className=' w-[80%] p-3 bg-green-500 rounded-lg text-white hover:bg-green-400 transition-all shadow-lg' onClick={()=>{
        toast.success("Order Placed")
  
}} >Place Order</button>
          </>:
          <div className=' text-center text-green-500 font-semibold text-2xl pt-5 ' >
            Empty Cart
            </div>}
